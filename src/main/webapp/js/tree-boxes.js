...
function treeBoxes(urlService, jsonData)
{
    ...
    var rectNode = { width : 150, height : 85, textMargin : 5 },  //change by shiva  { width : 120, height : 65, textMargin : 5 }
    ...
    function update(source)
    {
        ...
        nodeEnter.append('foreignObject')
            ...
            //code added by shiva to get info on side bar

            var sidebardata= d.MemberName +'<br>'+d.MemberDOB;

            var html = '<label><b>' + "Name: " + '</b><i>'+d.MemberName  + '</i></label>'
                + '<label><b>' + "DOB: " + '</b><i>'+ d.MemberDOB  + '</i></label>'
                + '<label><b>' + "Spouse: "+ '</b><i>' + d.Spouse   + '</i></label>'
                + '<label><b>' + "DOB: " + '</b><i>' + d.SpouseDOB + '</i></label>'
                + '<label><b>' + "Profession: " + '</b><i>' + d.Profession + '</i></label>'
                + '<label><b>' + "Qualification: " + '</b><i>' + d.Qualification + '</i></label>'
                + '<label><b>' + "Parents: " + '</b><i>'+ d.MotherName + '<br>' + d.FatherName + '</i></label>'
                + '<br>'
                + '<label><b>' + "Place Of Birth: " + '</b><i>' + d.PlaceOfBirth + '</i></label>'
                + '<label><b>' + "Address: " + '</b><i>' + d.Address + '<br>' + d.Town + " "+ '</i></label>'
                + '<label><b><i>' + d.Country + '</i></b></label>'
                + '<label><b>' + "About: " + '</b><i>' + d.Aboutme + '</i></label>';

            var nodedetails = '<div style="width: '
                    + (rectNode.width - rectNode.textMargin * 2) + 'px; height: '
                    + (rectNode.height - rectNode.textMargin * 2) + 'px;" class="node-text wordwrap"><a class="openbtn";opacity:0; onclick="opensidebar(\''+ html + '\' )";  >☰ About Info</a> '
                    + '<b><br>' + d.MemberName + '</b><br>'
                    + 'DOB: ' + d.MemberDOB + '<br>'
                    // + mDOD + '<br>'
                    + spouse;
        ...
        nodeEnterTooltip.append("text")
            ...
            .style('fill', 'white')
            .append("tspan")
            .text(function(d) {return 'Name: ' + d.MemberName;})
            .append("tspan")
            .attr('x', rectNode.width / 2 + tooltip.textMargin)
            .attr('dy', '1.5em')
            .text(function(d) {return 'Spouse: ' + d.Spouse;});
...
function opensidebar(data) {
    ...
    for (var i = 0; i < element.childNodes.length; i++) {
         if (element.childNodes[i].id === "121") {
    ...
    var html =
        '<a href="#" >' + data + '</a>';
    var p = document.getElementById("mySidebar");
    var newElement = document.createElement("p");
    newElement.setAttribute('id', 121);
    newElement.innerHTML = data;

    p.appendChild(newElement);


    // element.replaceChild(elemenchild.getElementsByTagName("a"),newElement);
...
function drawsidebar (data){
    var nodedetails = '<div>' + '<b><br>' + data + '<br>'+' </div>';
